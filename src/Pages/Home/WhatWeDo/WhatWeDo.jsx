  ...
  return (
    <div >
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-5 px-10 lg:px-0 '>
        ...
        <div className='image'
        >
          <img className='image__img lg:w-96 h-52 rounded-xl' src={img1} alt='' />
        ...
        <div className='image'>
          <img className='image__img lg:w-96 h-52 rounded-xl' src={img2} alt='' />
          <div className='image__overlay image__overlay--primary'>
            <div className='image__title'>Base Ball Camp</div>
          </div>
        </div>
        <div className='image'>
          <img className='image__img lg:w-96 h-52 rounded-xl' src={img3} alt='' />
          <div className='image__overlay image__overlay--primary'>
            <div className='image__title'>Football Camp</div>
          </div>
        </div>
        <div className='image'>
          <img className='image__img lg:w-96 h-52 rounded-xl' src={img4} alt='' />
          <div className='image__overlay image__overlay--primary'>
            <div className='image__title'>Football Camp</div>
          </div>
        </div>
        <div className='image'>
          <img className='image__img lg:w-96 h-52 rounded-xl' src={img5} alt='' />
          <div className='image__overlay image__overlay--primary'>
            <div className='image__title'>Cricket Batting Camp</div>
          </div>
        </div>
        <div className='image'>
          <img className='image__img lg:w-96 h-52 rounded-xl' src={img6} alt='' />
          <div className='image__overlay image__overlay--primary'>
